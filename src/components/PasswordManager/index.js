import {Component} from 'react' // Updated import statement
import {v4 as uuidv4} from 'uuid'
import PasswordItem from '../PasswordItem'
import './index.css'

class PasswordManager extends Component {
  // Fixed the 'component' to 'Component'
  state = {
    passwordRecords: [],
    inputUrl: '',
    inputName: '',
  ...
  addPasswordRecord = e => {
    ...
    this.setState(prevState => ({
      passwordRecords: [...prevState.passwordRecords, newPasswordRecords],
    }))
  }
